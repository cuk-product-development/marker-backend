...
const PRODUCTS = [
  ...
  { name: "Webcam 4K AI Tracking", cat: "webcam", price: 1450000, stock: 8, img: "https://images.unsplash.com/photo-1623949556303-b0d17d198949?w=500&h=500&fit=crop&q=80", desc: "4K 30fps, AI face tracking, wide FOV 90°, dual stereo mic." },
  ...
  { name: "USB-C Docking Station", cat: "usb", price: 580000, stock: 15, img: "https://images.unsplash.com/photo-1601445638532-3a6628c9f5f8?w=500&h=500&fit=crop&q=80", desc: "12-in-1 dock, 4K HDMI, 100W PD, SD/TF card, USB 3.0 x4." },
  { name: "Cable Management Kit", cat: "usb", price: 65000, stock: 80, img: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=500&fit=crop&q=80", desc: "Kabel tie 100pcs + velcro 10pcs + cable clips 20pcs." },
  ...
  { name: "Monitor Arm Dual", cat: "desk", price: 420000, stock: 10, img: "https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=500&h=500&fit=crop&q=80", desc: "Dual monitor arm VESA 75/100, rotation 360°, max 9kg/arm." },
  ...
  { name: "Wrist Rest Keyboard", cat: "desk", price: 95000, stock: 45, img: "https://images.unsplash.com/photo-1558618047-f4e60cef3895?w=500&h=500&fit=crop&q=80", desc: "Memory foam, anti-slip base, washable cover, 430mm." },
  ...
  { name: "Ethernet Cable Cat6 10m", cat: "network", price: 55000, stock: 100, img: "https://images.unsplash.com/photo-1631700611307-37dbcb89ef7e?w=500&h=500&fit=crop&q=80", desc: "Cat6 flat cable 10 meter, 1Gbps, gold-plated RJ45." },
  ...
  // Cooling
  { name: "Laptop Cooling Pad RGB", cat: "cooling", price: 185000, stock: 25, img: "https://images.unsplash.com/photo-1593642632559-0c6d3fc62b89?w=500&h=500&fit=crop&q=80", desc: "6 fan quiet 1200RPM, RGB, adjustable height, USB powered." },
  ...
  // Cables
  { name: "HDMI Cable 2.0 3m 4K", cat: "cable", price: 75000, stock: 90, img: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=500&h=500&fit=crop&q=80", desc: "HDMI 2.0 4K@60Hz, braided nylon, 3 meter, gold-plated." },
  { name: "USB-C to USB-C 100W", cat: "cable", price: 85000, stock: 75, img: "https://images.unsplash.com/photo-1601445638532-3a6628c9f5f8?w=500&h=500&fit=crop&q=80", desc: "100W PD, 480Mbps data, 1.5m braided, E-marker chip." },
